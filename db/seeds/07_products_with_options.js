  ...
  return knex(TABLE_NAME).del()
    .then(() => {
      return knex(TABLE_NAME).insert([
        ...
        {id: 2, product_id: 2, drink_size: 2, milk_type: 2, extra_options: 1, espresso_shots: 2, extra_espresso_shots:0, extra_espresso_shots_price:.75},
        ...
        {id: 4, product_id: 4, drink_size: 2, milk_type: 1, extra_options: null, espresso_shots: 2, extra_espresso_shots:0, extra_espresso_shots_price:.75},
